    ...
    <section className="py-20 lg:py-32 bg-bgLight dark:bg-bgDark">
      <div className="container">
            ...
            >
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-6">
                  <div 
                    className="w-14 h-14 rounded-2xl flex items-center justify-center text-2xl shadow-lg transition-transform group-hover:rotate-6"
                ...
                <h4 className="font-heading font-extrabold text-2xl text-brandDark dark:text-white mb-2 uppercase">
                  {phase.title}
                </h4>
                <p className="text-xs font-bold tracking-widest text-brandPrimary dark:text-brandGold mb-4">
                  {phase.subtitle}
                </p>

                <div className={`overflow-hidden transition-all duration-500 ${selectedPhase === index ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
                  <p className="text-sm text-brandDark/70 dark:text-surfaceLight/70 mb-6 leading-relaxed">
                    {phase.description}
                  </p>
        ...
        <div className="relative p-10 lg:p-16 bg-brandDark rounded-[40px] shadow-2xl overflow-hidden border border-white/10">
          <div className="absolute top-0 right-0 w-96 h-96 bg-brandAccent/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
          
          <div className="relative z-10 flex flex-col lg:flex-row gap-12 items-center">
            <div className="lg:w-1/2">
              <h3 className="font-heading font-black text-white text-3xl lg:text-4xl mb-6 uppercase tracking-tight">
            ...
            <div className="lg:w-1/2 w-full aspect-video rounded-3xl bg-gradient-to-br from-brandPrimary/20 to-brandAccent/10 border border-white/10 flex items-center justify-center relative group">
                <div className="absolute inset-0 bg-brandGold/5 animate-pulse rounded-3xl" />
                <div className="text-center relative z-10">
                   <div className="text-brandGold font-black text-5xl mb-2">INTEGRATED</div>
