    ...
    <section className="py-12 sm:py-16 md:py-20 bg-surfaceLight dark:bg-surfaceDark">
      <div className="container">
        ...
        <div className="mb-8 sm:mb-10 md:mb-12 text-center">
          <h2 className="mb-3 sm:mb-4 text-2xl sm:text-3xl md:text-4xl font-bold text-brandDark dark:text-brandAccent font-heading">
            Sustainability & ESG Service Portfolio
          </h2>
        ...
        <div className="mb-8 sm:mb-10 text-center">
          <h3 className="mb-2 text-xl sm:text-2xl font-bold text-brandDark dark:text-white font-heading">
            ESG Service Portfolio Architecture
          </h3>
        ...
        <div className="hidden lg:grid items-start gap-8 xl:gap-10 lg:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="w-full lg:sticky lg:top-24">
            <div className="p-5 xl:p-6 shadow-2xl bg-surfaceLight dark:bg-surfaceDark rounded-2xl border border-borderLight dark:border-borderDark">
              <div className="flex items-center justify-between mb-4">
                <p className="text-xs font-semibold uppercase tracking-[0.2em] text-brandDark dark:text-brandAccent">
                  Service Details
                </p>
              ...
              {activeService ? (
                <div>
                  <div className="flex items-center gap-3 xl:gap-4 mb-4">
                    <div
                      className="flex items-center justify-center flex-shrink-0 text-2xl xl:text-3xl shadow-lg w-12 h-12 xl:w-14 xl:h-14 rounded-xl"
                      style={{ backgroundColor: services[activeService].color }}
                    >
                      {services[activeService].icon}
                    </div>
                    <div>
                      <h4 className="text-lg xl:text-xl font-bold font-heading text-brandDark dark:text-white">
                        {services[activeService].title}
                      </h4>
                      <p className="text-xs xl:text-sm text-gray-600 dark:text-brandAccent">
                        Service Module {services[activeService].number}
                      </p>
                    </div>
                  </div>
                  <p className="mb-4 text-sm xl:text-base text-gray-700 dark:text-gray-300">
                    {services[activeService].description}
                  </p>
                  <div className="flex flex-wrap gap-2">
                    {services[activeService].offerings.map((offering, i) => (
            ...
            {/* Capabilities */}
            <div className="grid grid-cols-2 gap-4 xl:gap-6 p-5 xl:p-6 mt-6 shadow-lg bg-white/90 dark:bg-surfaceDark rounded-2xl border border-borderLight dark:border-borderDark">
              {capabilities.map((cap, index) => (
                <div key={index} className="flex items-center gap-2.5 xl:gap-3">
                  <div className="flex items-center justify-center flex-shrink-0 w-10 h-10 xl:w-12 xl:h-12 text-xl xl:text-2xl shadow-md bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-900 dark:to-blue-800 rounded-xl">
                    {cap.icon}
                  </div>
                  <span className="text-xs xl:text-sm font-semibold text-brandDark dark:text-white">
                    {cap.text}
                  </span>
                </div>
              ))}
        ...
        <div className="lg:hidden">
              ...
              return (
                ...
                >
                  <div className="flex flex-col items-center text-center">
                    <div className="flex items-center justify-center mb-2 text-xl sm:text-2xl w-10 h-10 sm:w-12 sm:h-12 bg-white/20 rounded-lg sm:rounded-xl backdrop-blur-sm border border-white/30">
                      {service.icon}
                    </div>
          ...
          <div className="mt-5 sm:mt-6">
            <div className="p-5 sm:p-6 shadow-2xl bg-surfaceLight dark:bg-surfaceDark rounded-2xl border border-borderLight dark:border-borderDark">
              ...
              {activeService ? (
                <div>
                  <div className="flex items-center gap-3 mb-3 sm:mb-4">
                    ...
                    <div>
                      <h4 className="text-base sm:text-xl font-bold font-heading text-brandDark dark:text-white">
                        {services[activeService].title}
                      </h4>
                  ...
                  <p className="mb-3 sm:mb-4 text-sm leading-relaxed text-gray-700 dark:text-gray-300">
                    {services[activeService].description}
                  </p>
          ...
          {/* Mobile Capabilities */}
          <div className="grid grid-cols-2 gap-3 sm:gap-4 p-4 sm:p-5 mt-5 sm:mt-6 shadow-lg bg-white/90 dark:bg-surfaceDark rounded-2xl border border-borderLight dark:border-borderDark">
            {capabilities.map((cap, index) => (
              <div key={index} className="flex items-center gap-2 sm:gap-3">
                <div className="flex items-center justify-center flex-shrink-0 w-9 h-9 sm:w-11 sm:h-11 text-lg sm:text-xl shadow-md bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-900 dark:to-blue-800 rounded-lg sm:rounded-xl">
                  {cap.icon}
                </div>
