...
//   return (
//     <section className="py-4 transition-colors duration-300 bg-bgLight dark:bg-bgDark sm:py-8">
...
//             >
//               <a href={industry.path} className="block w-full h-full">
...
//                     }`}
//                   >
//                     <h4 className="mb-3 text-sm font-bold tracking-tighter text-yellow-400 uppercase">
//                       {industry.subtitle}
//                     </h4>
//                     <p className="mb-5 text-sm leading-relaxed text-gray-200 line-clamp-4">
//                       {industry.description}
//                     </p>
 
//                     <div className="p-4 border-l-4 border-yellow-500 rounded-r-lg bg-white/10 backdrop-blur-md">
