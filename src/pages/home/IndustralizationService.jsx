...
import { Factory, HeartPulse, Home, Monitor, ShoppingCart, Zap } from "lucide-react";
...
export function IndustryGrid() {
  ...
  return (
    <section className="bg-gray-50 dark:bg-gray-900 py-12 sm:py-20 transition-colors duration-300">
