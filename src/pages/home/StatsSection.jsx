...
const StatsSection = () => {
  const stats = [
    ...
    },
    {
      ...
      gradient: "from-brandPrimary/85 via-brandDark/82 to-brandNavy/78",
    },
    {
      number: 300,
      suffix: "+",
    ...
    <section className="relative w-full pt-16 overflow-hidden bg-bgLight dark:bg-bgDark">
      ...
      <div className="container relative z-10 mx-auto">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <p className="mt-6 text-lg text-brandNavy/70 dark:text-white/60">
            Behind every milestone are numbers that reflect our growth,
            dedication, and commitment to delivering world-class solutions.
          </p>
        </div>
          ...
          {stats.map((stat, i) => {
            ...
            return (
              ...
              >
                ...
                {/* Content */}
                <div className="relative z-10 p-8 flex flex-col justify-between min-h-[360px] text-center">
                  {/* Icon */}
