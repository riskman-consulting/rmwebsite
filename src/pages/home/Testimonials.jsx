...
//               ✦ Testimonials
//             </span>
//             <h2 className="text-3xl md:text-4xl font-bold text-brandDark dark:text-white tracking-tight">
...
//                 </div>
//                 <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="text-brandGold/20 group-hover:text-brandGold/40 transition-colors">
...
const Testimonials = () => {
  ...
  return (
    <section className="relative w-full py-12 sm:py-24 bg-bgLight dark:bg-bgDark transition-colors duration-300 overflow-hidden">
            ...
            >
              ...
              <div className="inline-flex items-center gap-3 mb-8">
                <div className="flex items-center justify-center w-10 h-10 rounded-xl bg-brandNavy/5 dark:bg-brandAccent/10 text-brandGold dark:text-brandAccent">
                  <span className="font-black text-sm">{current.id.toString().padStart(2, '0')}</span>
                </div>
                <span className="text-xs font-black uppercase tracking-widest text-brandNavy/60 dark:text-white/50">
              ...
              <blockquote className="mb-10">
                <p className="text-xl md:text-2xl font-bold leading-relaxed text-brandDark dark:text-white italic">
                  "{current.text}"
                </p>
              </blockquote>
              ...
              <div className="flex items-center justify-between pt-8 border-t border-gray-100 dark:border-white/5">
                <div>
                  <h3 className="text-lg font-black text-brandDark dark:text-white uppercase tracking-tight">
                    {current.name}
                  </h3>
                ...
                <div className="w-12 h-12 rounded-full border-2 border-brandGold/20 flex items-center justify-center text-brandGold dark:border-brandAccent/20 dark:text-brandAccent">
