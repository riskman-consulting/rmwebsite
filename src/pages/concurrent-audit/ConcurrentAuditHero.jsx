...
//     return (
//         <section className="relative min-h-[90vh] flex items-center pt-32 pb-20 overflow-hidden bg-surfaceLight dark:bg-surfaceDark">
...
//                             className="text-4xl md:text-6xl font-extrabold leading-[1.1] text-brandDark dark:text-white mb-8 font-heading"
//                         >
//                             Concurrent Audit:<br />
