...
const ConcurrentAuditHero = () => {
    ...
    return (
        <section className="relative min-h-[90vh] flex items-center pt-32 pb-20 overflow-hidden bg-bgDark">
            {/* Background Decorative Elements */}
            <div className="absolute top-0 right-0 w-1/2 h-full bg-brandGold/5 blur-[120px] pointer-events-none" />
            <div className="absolute -bottom-24 -left-24 w-96 h-96 bg-brandNavy/10 rounded-full blur-[80px] pointer-events-none" />
                ...
                <div className="grid items-center gap-12 lg:grid-cols-2">
                    <div className="max-w-[750px]">
                        ...
                        <motion.h1
                            ...
                            className="text-4xl md:text-6xl font-extrabold leading-[1.1] text-brandLight mb-8 font-heading"
                        >
                            Concurrent Audit:<br />
                        ...
                        <motion.p
                            ...
                            className="text-lg font-light leading-relaxed text-brandLight/90 max-w-[620px] mb-10 font-sans"
                        >
                        ...
                        >
                            {stats.map((stat, index) => (
                                <div key={index} className="relative group">
                                    <div className="text-3xl font-bold leading-tight transition-transform duration-300 md:text-4xl text-brandGold font-heading group-hover:scale-105">
                                        {stat.number}
                                    </div>
                                    <div className="text-[0.7rem] tracking-[1.5px] uppercase text-brandLight/50 font-medium mt-1">
                                        {stat.label}
                                    </div>
                                </div>
                            ))}
