...
const WhyRiskManSection = ({ data }) => {
  return (
    <section className="relative py-10 overflow-hidden md:py-16 bg-bgLight dark:bg-bgDark">
      ...
      <div className="container relative z-10 px-4 sm:px-6 lg:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <h2 className="mb-6 text-3xl font-black sm:text-4xl md:text-5xl text-brandDark dark:text-brandLight font-heading">
              {data.title}
            </h2>
