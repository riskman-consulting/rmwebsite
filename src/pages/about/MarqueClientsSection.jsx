...
export default function MarqueeClientsSection({ title = "Our Marquee Clients", bgStyle = "bg-surfaceLight dark:bg-surfaceDark" }) {
  const clients = [
    ...
    { name: "Pernod Ricard", logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e2/Pernod_Ricard_logo_2019.svg/1280px-Pernod_Ricard_logo_2019.svg.png?20191029154406%22%22" },
    { name: "MG", logo: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdAh4d5LGfL36LCYs-6q8b5Co7C-wc7Wu84aFZ3C-p42E9ZhlLTahPZ_FvQrY&s&ec=121507538%22%22" },
    ...
    { name: "Care Health Insurance", logo: "https://pnghdpro.com/wp-content/themes/pnghdpro/download/social-media-and-brands/care-insurance-logo-hd.png%22%22" },
    {
      name: "Dhunseri", logo: "https://images.crunchbase.com/image/upload/c_pad,h_256,w_256,f_auto,q_auto:eco,dpr_1/824ef001f4a7bb492d3a?ik-sanitizeSvg=true%22%22"
    },
    {
    ...
    {
      name: "Bellavita", logo: "https://bellavitaluxury.co.in/cdn/shop/files/Bella_Vita_Logo_360_E_2x_d60de42b-fa50-45b3-b490-be70ac1fffa1.png?height=628&pad_color=fff&v=1706080456&width=1200%22%22"
    }
