...
export default function VideoHighlightsSection() {
  ...
  return (
    <section className="py-16 transition-colors duration-500 bg-bgLight dark:bg-bgDark">
      <div className="container">

        {/* ================= HEADER ================= */}
        <div className="max-w-3xl mx-auto mb-20 text-center">
          <div
            className="inline-flex items-center justify-center w-20 h-20 mb-6 border rounded-full bg-brandGold/10 border-brandGold/30"
          >
        ...
        <div className="grid gap-8 mb-20 lg:grid-cols-2">
          ...
          >
            <div className="relative overflow-hidden aspect-video">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div
                  className="flex items-center justify-center w-20 h-20 transition-transform duration-300 rounded-full bg-brandGold/90 group-hover:scale-110"
                >
              ...
              <div className="absolute bottom-0 p-8">
                <span className="inline-block px-3 py-1 mb-3 text-xs font-black tracking-wide rounded-full bg-brandGold/20 text-brandGold">
                  {videos[0].category}
                </span>
          ...
          <div className="space-y-4">
            {videos.slice(1).map((video) => (
              <div
                key={video.id}
                className="flex gap-4 p-4 transition-all duration-300 border group rounded-2xl bg-surfaceLight/80 dark:bg-surfaceDark/40 border-borderLight dark:border-borderDark hover:border-brandGold/40"
              >
                <div className="relative flex-shrink-0 w-32 h-24 overflow-hidden rounded-xl">
                  <img
                    src={video.thumbnail}
                    alt={video.title}
                  ...
                  <div className="absolute inset-0 flex items-center justify-center bg-black/40">
                    <div className="flex items-center justify-center w-10 h-10 rounded-full bg-brandGold">
                ...
                <div className="flex-1">
                  ...
                  <h4 className="text-lg font-bold transition-colors text-brandDark dark:text-white group-hover:text-brandGold">
                    {video.title}
                  </h4>
            ...
            {/* Subscribe */}
            <div
              className="p-6 border rounded-2xl bg-surfaceLight/80 dark:bg-surfaceDark/40 border-borderLight dark:border-borderDark"
            >
              ...
              <button className="px-6 py-3 font-bold transition-transform rounded-full bg-brandGold text-brandDark hover:scale-105">
                Subscribe Now
              </button>
            </div>
          </div>
