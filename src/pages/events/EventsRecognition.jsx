...
//   return (
//     /* FIX 1: Replace py-32 with responsive padding — py-10 on mobile, py-20 on lg+ */
//     <section
//       id="accomplishment"
//       className="relative px-4 sm:px-10 bg-gradient-to-b from-bgLight to-bgLight dark:from-bgDark dark:to-bgDark border-y border-borderLight dark:border-borderDark"
//     >
//       <div className="container px-6 pt-8 pb-10 mx-auto sm:px-6 lg:px-20 lg:pt-14 lg:pb-20">

//         {/* TABS & SEARCH
//             FIX 2: Tighten gap-8 → gap-4 on mobile; reduce mb-16 → mb-8 sm:mb-12 */}
...
//           {/* FIX 3: Input full-width on mobile with tighter padding */}
...
//         {/* HEADER — FIX 4: Reduce mb-12 → mb-6 sm:mb-10 */}
//         <div className="mb-6 sm:mb-10">
//           <h2 className="mb-3 text-3xl font-bold capitalize sm:text-4xl lg:text-5xl font-heading text-brandDark dark:text-white">
...
//         {/* GALLERY GRID
//             FIX 5: Remove fixed h-72; use aspect-ratio so images never crop unpredictably.
//             aspect-[4/3] gives a consistent 4:3 frame on all screen sizes. */}
...
//               >
//                 {/* FIX 6: object-cover + object-center keeps subject centred;
//                     width/height 100% via Tailwind w-full h-full ensures full fill */}
//                 <img
//                   src={item.image}
//                   alt="Achievement"
...
//               >
//                 {/* FIX 7: Lightbox image — contain so nothing is ever cropped */}
//                 <img
