  ...
  return (
    <section className="relative py-16 transition-colors duration-500 bg-bgLight dark:bg-bgDark">
      <div className="container">
        ...
        {/* Core Values */}
        <div className="grid gap-8 mx-auto mb-20 max-w-7xl md:grid-cols-2">
            ...
            return (
              ...
              >
                <div className="flex gap-5 mb-4">
                  <div className="flex items-center justify-center w-16 h-16 transition-transform duration-300 border rounded-2xl bg-brandGold/10 border-brandGold/30 group-hover:scale-110">
        ...
        <div className="grid max-w-6xl grid-cols-2 gap-6 mx-auto mb-20 lg:grid-cols-4">
          {additionalValues.map((value, index) => {
            ...
            return (
              <div
                key={index}
                className="p-6 transition-all duration-300 border rounded-2xl bg-surfaceLight/70 dark:bg-surfaceDark/40 border-borderLight dark:border-borderDark backdrop-blur-xl hover:-translate-y-1 hover:border-brandGold/40"
              >
                <div className="flex items-center justify-center w-12 h-12 mb-4 border rounded-xl bg-brandGold/10 border-brandGold/30">
        ...
        <div className="grid max-w-6xl grid-cols-2 gap-8 mx-auto lg:grid-cols-4">
          {[
            ...
            return (
              ...
              >
                <div className="flex items-center justify-center w-16 h-16 mx-auto mb-4 border rounded-full bg-brandGold/10 border-brandGold/30">
