// ============================================
// Navbar.jsx - FIXED MEGA MENU POSITIONING
// ============================================
...
export const Navbar = ({
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 w-full h-20 border-b bg-bgLight dark:bg-bgDark border-borderLight dark:border-borderDark">
