    ...
    return (
        <>
            {/* =======================
               ANNOUNCEMENT BANNER
            ======================= */}
            <div className="fixed top-0 left-0 right-0 z-[60] w-full h-[48px] bg-bgDark flex items-center justify-center">
                <div className="container px-4 mx-auto">
                    <p className="text-center text-[14px] text-white font-medium leading-tight">
                        ...
                        <a href="/orientation" className="inline-block px-2 py-1 font-bold transition-colors border-2 rounded-full border-brandDark hover:text-white/70">
                            Orientation Program
                        </a>
                        {" "}for each part or{" "}
                        <a href="/contact" className="inline-block px-2 py-1 font-bold transition-colors border-2 rounded-full border-brandDark hover:text-white/70">
                            Contact Us
                        </a>
                        {" "}to get started! 💡
                    </p>
            ...
            <nav className="fixed top-[48px] left-0 right-0 z-50 w-full h-20 border-b bg-bgLight dark:bg-bgDark border-borderLight dark:border-borderDark">
                <div className="container flex items-center h-full">
                    ...
                    <div className="flex items-center h-full">
                        ...
                        {/* LOGO */}
                        <a href="/" className="flex items-center flex-shrink-0 h-16 w-36">
                            <div className="relative flex items-center justify-start w-full h-full">
                                <img
                                    className="block object-contain w-auto h-12 dark:hidden"
                                    src="/rm.png"
                                    alt="Riskman"
                                />
                                <img
                    ...
                    >
                        ...
                        <Link
                            ...
                            className="
                                ...
                                rounded-full
                                bg-brandDark dark:bg-brandGold hover:bg-brandNavy
