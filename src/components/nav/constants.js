/**
 * constants.js
 * Central data configuration for RiskMan Navigation.
 * Includes Main Nav, Mega Menus, and Sub-menus.
 */
...
export const NAVIGATION_DATA = {
    ...
    // Services Mega Menu: Organized by Service Categories
    "servicesMegaMenu": [
        {
            ...
            "items": [
                ...
                { "label": "Forensics and Investigation", "path": "/services/forensics-investigation" }
            ]
        },
        {
