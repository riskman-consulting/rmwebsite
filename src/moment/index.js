...
export const PHOTOS= [
  ...
  { id: 26, category: "Meetings & Discussions", title: "Strategy Meeting", date: "Mar 2024", image: IIA_Internal_Leadership_2025_images[0], description: "Important strategy discussion" },
  ...
  { id: 35, category: "Conference Sessions", title: "IIA Conference Delhi", date: "Jul 2024", image: journeyImages.iiaDelhiJuly2024[0], description: "IIA Conference in Delhi" },
  { id: 36, category: "Conference Sessions", title: "Conference Session", date: "Jul 2024", image: journeyImages.iiaDelhiJuly2024[1], description: "Conference session highlights" },
  { id: 37, category: "Conference Sessions", title: "Knowledge Exchange", date: "Jul 2024", image: journeyImages.iiaDelhiJuly2024[2], description: "Exchange at IIA Delhi" },
  { id: 38, category: "Conference Sessions", title: "Networking Delhi", date: "Jul 2024", image: journeyImages.iiaDelhiJuly2024[3], description: "Networking at IIA Delhi" },

  { id: 39, category: "Conference Sessions", title: "IIA Mumbai 2025", date: "Mar 2025", image: journeyImages.iiaMumbaiMarch2025[0], description: "Professional conference in Mumbai" },
  { id: 40, category: "Conference Sessions", title: "Mumbai Session Highlights", date: "Mar 2025", image: journeyImages.iiaMumbaiMarch2025[1], description: "IIA Mumbai highlights" },
  { id: 41, category: "Conference Sessions", title: "Conference Environment", date: "Mar 2025", image: journeyImages.iiaMumbaiMarch2025[2], description: "Environment at IIA Mumbai" },
  { id: 42, category: "Conference Sessions", title: "Professional Interaction", date: "Mar 2025", image: journeyImages.iiaMumbaiMarch2025[3], description: "Interaction at IIA Mumbai" },
  { id: 43, category: "Conference Sessions", title: "Learning Mumbai", date: "Mar 2025", image: journeyImages.iiaMumbaiMarch2025[4], description: "Learning opportunities" },
  { id: 44, category: "Conference Sessions", title: "Conference Moments", date: "Mar 2025", image: journeyImages.iiaMumbaiMarch2025[5], description: "Moments at IIA Mumbai" },
  { id: 45, category: "Conference Sessions", title: "Networking Mumbai", date: "Mar 2025", image: journeyImages.iiaMumbaiMarch2025[6], description: "Networking at IIA Mumbai" },
  { id: 46, category: "Conference Sessions", title: "Industry Engagement", date: "Mar 2025", image: journeyImages.iiaMumbaiMarch2025[7], description: "Engagement at IIA Mumbai" },
  { id: 47, category: "Conference Sessions", title: "Closing Moments", date: "Mar 2025", image: journeyImages.iiaMumbaiMarch2025[8], description: "Closing at IIA Mumbai" },

  { id: 48, category: "Conference Sessions", title: "IIA Mumbai 2026", date: "Jan 2026", image: journeyImages.iiaMumbaiJan2026[0], description: "Conference Jan 2026" },
  { id: 49, category: "Conference Sessions", title: "2026 Sessions", date: "Jan 2026", image: journeyImages.iiaMumbaiJan2026[1], description: "IIA Mumbai sessions" },
  { id: 50, category: "Conference Sessions", title: "Knowledge Sharing 2026", date: "Jan 2026", image: journeyImages.iiaMumbaiJan2026[2], description: "Sharing at IIA Mumbai" },
  { id: 51, category: "Conference Sessions", title: "Networking 2026", date: "Jan 2026", image: journeyImages.iiaMumbaiJan2026[3], description: "Networking at IIA Mumbai" },
  { id: 52, category: "Conference Sessions", title: "Conference Floor", date: "Jan 2026", image: journeyImages.iiaMumbaiJan2026[4], description: "Floor view Mumbai" },
  { id: 53, category: "Conference Sessions", title: "Insights 2026", date: "Jan 2026", image: journeyImages.iiaMumbaiJan2026[5], description: "Insights from Mumbai" },
  { id: 54, category: "Conference Sessions", title: "Closing Session 2026", date: "Jan 2026", image: journeyImages.iiaMumbaiJan2026[6], description: "Closing IIA Mumbai 2026" },
];
