...
const RiskManTimeline = () => {
  ...
  return (
    <section 
      className="relative min-h-screen py-24 px-4 sm:px-8 bg-surfaceLight dark:bg-bgDark transition-colors duration-500 overflow-hidden"
    ...
    >
      <div className="container max-w-7xl mx-auto">
        ...
        <div className="flex flex-col items-center mb-24 text-center">
          ...
          <h1 className="text-6xl md:text-7xl font-black tracking-tighter text-brandDark dark:text-brandLight mb-8 font-heading">
            How it <span className="text-brandPrimary dark:text-brandAccent italic">Began</span>
          </h1>

          {/* Perspective Switcher */}
          <div className="flex p-1 rounded-full bg-brandLight dark:bg-surfaceDark border border-borderLight dark:border-borderDark shadow-inner">
            ...
            {currentTimeline.map((item, idx) => (
              ...
              >
                ...
                <div className="mb-6">
                  ...
                  <h2 className="text-5xl font-black text-brandDark dark:text-brandLight leading-none font-heading">
                    {item.year.split('-')[0]}
                  </h2>
                </div>
                ...
                <div className="relative group">
                  <div className="p-6 bg-white dark:bg-surfaceDark border border-borderLight dark:border-borderDark shadow-xl dark:shadow-none hover:border-brandPrimary dark:hover:border-brandAccent transition-colors duration-500">
                    ...
                    {/* Impact Tag */}
                    <div className="mt-4 pt-4 border-t border-borderLight dark:border-borderDark">
        ...
        <div className="mt-32 grid grid-cols-2 lg:grid-cols-4 gap-8 border-t border-borderLight dark:border-borderDark pt-12">
...
const Stat = ({ value, label }) => (
  <div className="text-left">
    <h4 className="text-4xl font-black text-brandDark dark:text-brandLight leading-none mb-2 font-heading">{value}</h4>
