...
export default function MarqueeClientsSection({ title = "Our Clients", bgStyle = "bg-surfaceLight dark:bg-surfaceDark" }) {
  const clients = [
    ...
    { name: "Khadim", logo: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRWEmaB3pM2vVJ5A0BRuHNylNtyZNSCTAVIbrStMsvZq_DZiy5-BQwAvlwd41k&s&ec=121507538" },
    ...
    { name: "MG", logo: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQdAh4d5LGfL36LCYs-6q8b5Co7C-wc7Wu84aFZ3C-p42E9ZhlLTahPZ_FvQrY&s&ec=121507538" },
    ...
    {
      name: "Dhunseri", logo: "https://images.crunchbase.com/image/upload/c_pad,h_256,w_256,f_auto,q_auto:eco,dpr_1/824ef001f4a7bb492d3a?ik-sanitizeSvg=true"
    },
    {
    ...
    {
      name: "Bellavita", logo: "https://bellavitaluxury.co.in/cdn/shop/files/Bella_Vita_Logo_360_E_2x_d60de42b-fa50-45b3-b490-be70ac1fffa1.png?height=628&pad_color=fff&v=1706080456&width=1200"
    }
